...
- Separated V1 & V2 Libraries in two separate .so files, for V1 users can use librocprofiler64.so and rocprofiler.h and for V2 users can use librocprofiler64v2.so and v2/rocprofiler.h
