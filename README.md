...
There two usage modes for counters access, system wide sampling and accumulating per kernels. In per kernel usage mode the kernels execution is serialized.
