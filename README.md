...
There two usage modes for counters access, system wide sampling and per kernels accumulating. In per kernel usage mode the kernels execution is serialized.
